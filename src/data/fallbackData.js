...
export const noticeItems = [
  ...
  },
  {
    ...
    target: "교직원",
    description:
      "학교 단체검진 외에 개별적으로 건강검진을 받은 경우 제출·업로드 센터에서 확인 가능한 자료를 제출해주세요.",
    actionText: "제출·업로드 센터에서 확인서 제출",
    status: "접수 중",
    badgeType: "green"
  },
  {
...
export const uploadItems = [
  ...
  {
    title: "개별 건강검진 확인서 제출",
    titleLines: ["개별 건강검진", "확인서 제출"],
    description: "학교 단체검진 외에 개별적으로 건강검진을 받은 경우 확인 가능한 자료를 제출합니다. 먼저 ‘나의 제출·이수 현황’에서 올해 검진 완료 여부를 확인해 주세요. 이미 검진 완료로 표시되어 있다면 별도 확인서를 제출하지 않으셔도 됩니다.",
    target: "개별 건강검진 또는 국민건강보험공단 건강검진을 받은 교직원",
    documentType: "개별 병·의원 검진: 검진 날짜와 의료기관명이 확인되는 페이지\n국민건강보험공단 검진: 국민건강보험공단에서 발급한 건강검진확인서",
    deadline: "별도 안내일까지",
    fileGuide: "검진 여부 확인에 필요한 최소 정보만 제출해 주세요. 검사 결과 수치 등 불필요한 건강정보는 제출하지 마세요.",
    buttonText: "확인서 업로드하기",
    url: "",
    status: "접수 중",
    uploadType: "file",
    highlight: true
...
export const checkupItems = [
  ...
  },
  {
    ...
    target: "교직원",
    details: ["검진 가능 시간 확인", "검진 장소 확인", "개별 건강검진 확인서 제출 방법", "채용검진 대체 인정 확인 방법"],
...
export const resourceItems = [
  ...
  { title: "교직원 결핵검진 안내문", category: "교직원 검진", description: "교직원 결핵검진 일정, 인정 기준, 개별 건강검진 확인서 제출 방법을 정리한 자료입니다.", buttonText: "자료 열기", url: "" },
...
export const messageTemplates = [
  ...
  {
    title: "개별 건강검진 확인서 제출 안내",
    category: "교직원 검진",
    content:
      "안녕하세요, 보건실입니다.\n\n학교 단체검진 외에 개별적으로 건강검진을 받은 경우,\n온라인 보건실의 제출·업로드 센터에서 확인 가능한 자료를 제출해주시기 바랍니다.\n\n검사 결과 수치 등 불필요한 건강정보는 제출하지 마세요.\n제출 후 보건실 확인까지 시간이 소요될 수 있습니다.\n감사합니다."
  },
  {
...
export const faqItems = [
  { question: "개별 건강검진 확인서는 어디에 제출하나요?", answer: "제출·업로드 센터의 '개별 건강검진 확인서 제출' 메뉴에서 업로드해주세요." },
