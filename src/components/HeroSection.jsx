...
export default function HeroSection({ config, action }) {
  ...
  return (
    <section id="home" className="mx-auto w-full max-w-6xl px-3 pb-1 pt-3 sm:px-4 lg:max-w-[1280px]">
      <div className="rounded-[12px] border border-[#DDEAE7] bg-white px-3 py-3 text-[#102047] shadow-[0_6px_16px_rgba(16,32,71,0.035)] sm:px-4 sm:py-4 lg:px-4 lg:py-4">
        <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(400px,420px)] lg:items-center lg:gap-8">
          <div className="min-w-0 self-center lg:px-0 lg:py-12">
            ...
            {notices.length > 0 && (
              <div className="mt-3 inline-flex max-w-full rounded-[8px] border border-[#DDEAE7] bg-[#F8FAFA] px-2.5 py-1.5 text-[11px] font-normal leading-5 text-[#3154A3] sm:text-xs">
                {notices.join(" ")}
              </div>
            )}
          </div>
