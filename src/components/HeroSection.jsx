...
export default function HeroSection({ config, action }) {
  ...
  return (
    <section id="home" className="mx-auto w-full max-w-6xl px-3 pb-1.5 pt-3 sm:px-4 lg:max-w-[1280px]">
      <div className="rounded-[12px] border border-[#DDEAE7] bg-white p-3 text-[#102047] shadow-[0_8px_20px_rgba(16,32,71,0.04)] sm:p-3.5">
        <div className="grid gap-2.5 lg:grid-cols-[minmax(0,1fr)_minmax(320px,410px)] lg:items-center">
