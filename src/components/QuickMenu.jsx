      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-3 lg:grid-cols-4 lg:gap-4">
        {items.map((item) => (
          <button
            ...
            className={`min-h-32 min-w-0 rounded-2xl border p-3 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-md sm:min-h-40 sm:rounded-[24px] sm:p-5 lg:min-h-48 lg:p-6 ${
          ...
          >
            ...
            <p className="menu-card-description mt-1 text-xs leading-5 text-slate-600 sm:mt-2 sm:text-sm sm:leading-6 lg:text-[0.95rem]">{item.description}</p>
          </button>
        ))}
      </div>
    </section>
