      ...
      <AccessMessage
        ...
        action={
          <button
            ...
            onClick={handleSignOut}
            disabled={isWorking}
            className="mt-6 min-h-12 rounded-2xl border border-[#DDEAE7] bg-white px-5 py-3 text-sm font-semibold text-[#102047] transition hover:-translate-y-[1px] disabled:cursor-not-allowed disabled:opacity-50"
          >
            로그아웃
          </button>
        }
